      ...
      <div style={showInputs ? getStyles(theme).modalExpanded : getStyles(theme).modal}>
        ...
        {canEditFee && showSettingsMenu && (
          <div style={getStyles(theme).settingsMenu} ref={settingsMenuRef}>
            ...
            <label style={getStyles(theme).settingsItem}>
              <input type="checkbox" checked={manualFees} onChange={() => setManualFees(!manualFees)} />
              Edit fees manually
            </label>
            <label style={getStyles(theme).settingsItem}>
              <input type="checkbox" checked={lockTimeEnabled} onChange={() => setLockTimeEnabled(!lockTimeEnabled)} />
              Edit lockTime
            </label>
            <label style={getStyles(theme).settingsItem}>
              <input type="checkbox" checked={useChangeAddr} onChange={() => setUseChangeAddr(!useChangeAddr)} />
            ...
            <div style={getStyles(theme).body}>
              ...
              <div style={getStyles(theme).formRow}>
                ...
                {!manualFees && (
                  <div style={getStyles(theme).feeLine}>
                    ...
                    <span style={getStyles(theme).xBytes}>≈ {feeDoge.toFixed(8)} DOGE</span>
                  </div>
                )}
                {manualFees && canEditFee && (
                  <div style={getStyles(theme).feeLine}>
                    ...
                    <span style={{ marginLeft: '0.6rem' }}>~ {feeDoge.toFixed(8)} DOGE</span>
                  </div>
                )}
                {manualFees && !canEditFee && (
                  <div>
              ...
              {draftLoading && (
                <div style={getStyles(theme).loadingDraft}>
                  <img src="/images/spinner.gif" alt="loading" style={{ width: 20, height: 20, marginRight: 8 }} />
        ...
        {sentTxid && (
          <div style={getStyles(theme).successContainer}>
            <img src="/images/success.png" alt="success" style={{ width: 64, height: 64, marginBottom: '0.5rem' }} />
